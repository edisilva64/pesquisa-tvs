/* ===================================================================
   ...
   FLUXO DE JOGO:
   1. Escolha do MÓDULO (Quiz Geral ou Quiz Turismo)
   2. Escolha do NÍVEL (Fácil / Médio / Difícil) dentro do módulo
   3. Blocos de 10 perguntas, com opção de continuar (nível mais
      difícil) ou parar e ver o resultado ao final de cada bloco
   =================================================================== */
...
(function () {
  ...
  /** Jogador escolheu o módulo (ex: 'geral' ou 'turismo'): busca as perguntas e mostra a escolha de nível */
